...
// ============================================================
// Megafunction Name(s):
// 			asj_fft_si_de_so_b_fft_111
// ============================================================
// Generated by FFT 11.1 [Altera, IP Toolbench 1.3.0 Build 173]
// ************************************************************
...
module fft_core (
	...
	asj_fft_si_de_so_b_fft_111	asj_fft_si_de_so_b_fft_111_inst(
		.clk(clk),
		.reset_n(reset_n),
		.inverse(inverse),
	...
	defparam
		asj_fft_si_de_so_b_fft_111_inst.nps = 1024,
		asj_fft_si_de_so_b_fft_111_inst.bfp = 1,
		asj_fft_si_de_so_b_fft_111_inst.nume = 2,
		asj_fft_si_de_so_b_fft_111_inst.mpr = 16,
		asj_fft_si_de_so_b_fft_111_inst.twr = 16,
		asj_fft_si_de_so_b_fft_111_inst.bpr = 16,
		asj_fft_si_de_so_b_fft_111_inst.bpb = 4,
		asj_fft_si_de_so_b_fft_111_inst.fpr = 4,
		asj_fft_si_de_so_b_fft_111_inst.mram = 0,
		asj_fft_si_de_so_b_fft_111_inst.m512 = 0,
		asj_fft_si_de_so_b_fft_111_inst.mult_type = 1,
		asj_fft_si_de_so_b_fft_111_inst.mult_imp = 0,
		asj_fft_si_de_so_b_fft_111_inst.dsp_arch = 0,
		asj_fft_si_de_so_b_fft_111_inst.srr = "AUTO_SHIFT_REGISTER_RECOGNITION=OFF",
		asj_fft_si_de_so_b_fft_111_inst.rfs1 = "fft_core_1n1024sin.hex",
		asj_fft_si_de_so_b_fft_111_inst.rfs2 = "fft_core_2n1024sin.hex",
		asj_fft_si_de_so_b_fft_111_inst.rfs3 = "fft_core_3n1024sin.hex",
		asj_fft_si_de_so_b_fft_111_inst.rfc1 = "fft_core_1n1024cos.hex",
		asj_fft_si_de_so_b_fft_111_inst.rfc2 = "fft_core_2n1024cos.hex",
		asj_fft_si_de_so_b_fft_111_inst.rfc3 = "fft_core_3n1024cos.hex";
endmodule
...
// Retrieval info: <MEGACORE title="FFT MegaCore Function"  version="11.1"  build="173"  iptb_version="1.3.0 Build 173"  format_version="120" >
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.FFTModelClass"  active_core="asj_fft_si_de_so_b_fft_111" >
...
// Retrieval info:      <PRIVATE name = "NUM_M4K" value="14"  type="INTEGER"  enable="1" />
